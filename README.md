...
**176 findings it can reach. One line saying which one to fix first.**
...
**40 things are inspected**, and **176 distinct conclusions** can come out of
them: 145 are faults, 31 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1444 tests, no dependencies
