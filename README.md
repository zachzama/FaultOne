...
**187 findings it can reach. One line saying which one to fix first.**
...
**41 things are inspected**, and **187 distinct conclusions** can come out of
them: 154 are faults, 33 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1660 tests, no dependencies
