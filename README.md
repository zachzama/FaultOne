...
**171 findings it can reach. One line saying which one to fix first.**
...
**38 things are inspected**, and **171 distinct conclusions** can come out of
them: 141 are faults, 30 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1389 tests, no dependencies
