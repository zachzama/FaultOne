...
`-C` because OpenSSH doesn't compress by default, and the file is 1055 KB of
...
Stripped and compressed together it's 219 KB instead of 1055. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1820 tests, no dependencies
