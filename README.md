...
**178 findings it can reach. One line saying which one to fix first.**
...
**41 things are inspected**, and **178 distinct conclusions** can come out of
them: 147 are faults, 31 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1474 tests, no dependencies
