...
`-C` because OpenSSH doesn't compress by default, and the file is 1040 KB of
repetitive text: it goes over the wire at 314 KB with compression on, for the
cost of one flag.
...
Stripped and compressed together it's 217 KB instead of 1040. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1766 tests, no dependencies
