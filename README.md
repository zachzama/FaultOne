...
**175 findings it can reach. One line saying which one to fix first.**
...
**39 things are inspected**, and **175 distinct conclusions** can come out of
them: 144 are faults, 31 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1435 tests, no dependencies
