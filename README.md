...
**167 findings it can reach. One line saying which one to fix first.**
...
**37 things are inspected**, and **167 distinct conclusions** can come out of
them: 139 are faults, 28 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1372 tests, no dependencies
