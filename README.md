...
**127 findings it can reach. One line saying which one to fix first.**
...
**26 things are inspected**, and **127 distinct conclusions** can come out of
them — 110 are faults, 17 are context.
...
- `test_faultone.py` — `python3 test_faultone.py`, 634 tests, no dependencies
