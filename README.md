...
`-C` because OpenSSH doesn't compress by default, and the file is 1013 KB of
...
Stripped and compressed together it's 213 KB instead of 1013. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1737 tests, no dependencies
