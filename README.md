...
`-C` because OpenSSH doesn't compress by default, and the file is 1054 KB of
...
Stripped and compressed together it's 218 KB instead of 1054. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1811 tests, no dependencies
