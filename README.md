...
**159 findings it can reach. One line saying which one to fix first.**
...
**33 things are inspected**, and **159 distinct conclusions** can come out of
them: 134 are faults, 25 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1018 tests, no dependencies
