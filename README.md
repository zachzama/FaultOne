...
**126 findings it can reach. One line saying which one to fix first.**
...
**26 things are inspected**, and **126 distinct conclusions** can come out of
them — 109 are faults, 17 are context.
...
- `test_faultone.py` — `python3 test_faultone.py`, 627 tests, no dependencies
