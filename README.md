...
**165 findings it can reach. One line saying which one to fix first.**
...
**36 things are inspected**, and **165 distinct conclusions** can come out of
them: 138 are faults, 27 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1334 tests, no dependencies
