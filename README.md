...
**166 findings it can reach. One line saying which one to fix first.**
...
**37 things are inspected**, and **166 distinct conclusions** can come out of
them: 138 are faults, 28 are context.
...
- `test_faultone.py`: `python3 test_faultone.py`, 1352 tests, no dependencies
