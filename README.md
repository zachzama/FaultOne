...
- **1991 tests**, and a test that fails if any of them asserts nothing at all.
- **411 mutations**, each one breaking a rule on purpose. Every one has to make
...
- `test_faultone.py`: `python3 test_faultone.py`, 1991 tests, no dependencies
