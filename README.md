...
`-C` because OpenSSH doesn't compress by default, and the file is 1076 KB of
...
Stripped and compressed together it's 222 KB instead of 1076. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1864 tests, no dependencies
