...
`-C` because OpenSSH doesn't compress by default, and the file is 1052 KB of
repetitive text: it goes over the wire at 318 KB with compression on, for the
cost of one flag.
...
Stripped and compressed together it's 218 KB instead of 1052. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1794 tests, no dependencies
