...
**160 findings it can reach. One line saying which one to fix first.**
...
**33 things are inspected**, and **160 distinct conclusions** can come out of
...
- `test_faultone.py`: `python3 test_faultone.py`, 1056 tests, no dependencies
