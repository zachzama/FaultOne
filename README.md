...
`-C` because OpenSSH doesn't compress by default, and the file is 1053 KB of
...
Stripped and compressed together it's 218 KB instead of 1053. That is 79%
...
- `test_faultone.py`: `python3 test_faultone.py`, 1809 tests, no dependencies
