...
**135 findings it can reach. One line saying which one to fix first.**
...
**26 things are inspected**, and **135 distinct conclusions** can come out of
them — 118 are faults, 17 are context.
...
- `test_faultone.py` — `python3 test_faultone.py`, 677 tests, no dependencies
