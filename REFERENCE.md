...
difference is which one it puts at the top, and that is the whole product: 184
...
| **Findings** | **184** | Distinct conclusions it can reach and state in plain language. 151 are faults; 33 are context, like which switch port you're on. |
| **Ranked causes** | **151** | Findings the verdict knows how to rank and assign an owner to. |
| **Automated tests** | **531** | 1614 tests of this program's own code. A developer number, not a measure of what it checks for you. |

**The 184 findings are the useful figure** if you want to know what the tool can
...
python3 test_faultone.py           # 1614 tests, a few seconds, no dependencies
```
...
```
FaultOne 1.19.0 - Linux - python 3.11.2 - 2026-08-06T15:16:44-07:00
```
...
```
FaultOne 1.19.0 - Linux - 2026-08-06T14:58:06-07:00
```
...
1614 tests, no dependencies, no network, a few seconds, so they run
...
> way out - and who owns it. Ranks 184 findings with readable rules instead of
