...
difference is which one it puts at the top, and that is the whole product: 187
...
| **Findings** | **187** | Distinct conclusions it can reach and state in plain language. 154 are faults; 33 are context, like which switch port you're on. |
| **Ranked causes** | **154** | Findings the verdict knows how to rank and assign an owner to. |
| **Automated tests** | **531** | 1656 tests of this program's own code. A developer number, not a measure of what it checks for you. |

**The 187 findings are the useful figure** if you want to know what the tool can
...
python3 test_faultone.py           # 1656 tests, a few seconds, no dependencies
```
...
1656 tests, no dependencies, no network, a few seconds, so they run
...
> way out - and who owns it. Ranks 187 findings with readable rules instead of
