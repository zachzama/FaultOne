...
| **Automated tests** | **531** | 1227 tests of this program's own code. A developer number, not a measure of what it checks for you. |
...
python3 test_faultone.py           # 1227 tests, a few seconds, no dependencies
```
...
```
FaultOne 1.14.0 - Linux - python 3.11.2 - 2026-08-06T15:16:44-07:00
```
...
```
FaultOne 1.14.0 - Linux - 2026-08-06T14:58:06-07:00
```
...
1227 tests, no dependencies, no network, a few seconds, so they run
