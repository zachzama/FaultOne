...
| **Automated tests** | **531** | 873 tests of this program's own code. A developer number, not a measure of what it checks for you. |
...
python3 test_faultone.py           # 873 tests, a few seconds, no dependencies
```
...
873 tests, no dependencies, no network, a few seconds — so they run
