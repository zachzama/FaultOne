...
| **Automated tests** | **531** | 918 tests of this program's own code. A developer number, not a measure of what it checks for you. |
...
python3 test_faultone.py           # 918 tests, a few seconds, no dependencies
```
...
918 tests, no dependencies, no network, a few seconds — so they run
