...
| **Automated tests** | **531** | 869 tests of this program's own code. A developer number, not a measure of what it checks for you. |
...
python3 test_faultone.py           # 869 tests, a few seconds, no dependencies
```
...
869 tests, no dependencies, no network, a few seconds — so they run
