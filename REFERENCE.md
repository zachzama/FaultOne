...
| **Automated tests** | **531** | 915 tests of this program's own code. A developer number, not a measure of what it checks for you. |
...
python3 test_faultone.py           # 915 tests, a few seconds, no dependencies
```
...
915 tests, no dependencies, no network, a few seconds — so they run
