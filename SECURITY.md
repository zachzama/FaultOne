...
- **It runs real commands with your privileges.** They are the ones you would
  run by hand, as an argv list and never through a shell. It reads counters,
  sends pings and traceroutes, and opens TCP connections to targets you name.
